...
-- Description: Schema initialization script for Oracle environment.
-- ====================================================================
...
CREATE TABLE sdm_users (
    ...
    role VARCHAR2(50) DEFAULT 'MAKER' NOT NULL, -- MAKER, CHECKER, ADMIN
...
CREATE TABLE sdm_applications (
    app_code VARCHAR2(3) PRIMARY KEY,
...
CREATE TABLE sdm_documents (
    id VARCHAR2(50) PRIMARY KEY,       -- e.g. P001, P002 ... P016
    phase_number NUMBER(10) NOT NULL,   -- 1 to 7
    phase_name VARCHAR2(100) NOT NULL,  -- Phase 1 to Phase 7 names
    title VARCHAR2(255) NOT NULL,       -- Document Deliverable Title
    description VARCHAR2(1000)          -- Configurable description
);
...
CREATE TABLE sdm_document_versions (
    ...
    version_number VARCHAR2(50) NOT NULL,  -- Configurable version
    document_code VARCHAR2(100) NOT NULL,  -- Configurable code
    file_name VARCHAR2(255) NOT NULL,
    file_type VARCHAR2(50) NOT NULL,       -- EXCEL, WORD, POWERPOINT, XML, etc.
    status VARCHAR2(50) NOT NULL,          -- PENDING_APPROVAL, APPROVED, REJECTED
    maker_username VARCHAR2(100) NOT NULL,
    checker_username VARCHAR2(100),
    rejection_remarks VARCHAR2(1000),
    parsed_sections_json CLOB,             -- Extracted sections/tabs and contents
